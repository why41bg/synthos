export class IMPromptStore {
    ...
    public static getSummarizePrompt(
        ...
        "detail": "25-美团上海杨浦站长（已黑化）推荐使用国产香橙派替代昂贵的树莓派搭建软路由，称其功耗低、性能足够，配合主动散热可稳定运行OpenWrt系统。29-AAA学术合作随时回复表示赞同，并提到若能获取电信公网IP则‘更好玩’。快跑质疑退役笔记本是否可行，被站长以‘功耗高’否定。25-杨浦美团人机-被川普毁了版则提醒香橙派‘发热巨严重’，不适合长时间负载。讨论体现出群友对低成本自建网络设备的浓厚兴趣及实际使用中的散热与兼容性顾虑。"
        }
        ]
